...
public class FlutterWebView implements PlatformView, MethodCallHandler {
    ...
    @SuppressWarnings("unchecked")
    private void takeScreenShot(MethodCall methodCall, Result result) {
        Map<String, Object> request = (Map<String, Object>) methodCall.arguments;
        Bitmap.CompressFormat compressFormat = Bitmap.CompressFormat.valueOf((String) request.get("compressFormat"));
        int quality = (int) request.get("quality");
